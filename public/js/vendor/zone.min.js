!function(e, t) {
	...
	function r(e, t) {
		var r = [];
		for (var o in e) "on" == o.substr(0, 2) && r.push(o);
		for (var a = 0; a < r.length; a++) n(e, r[a]);
		if (t)
			for (var i = 0; i < t.length; i++) n(e, "on" + t[i])
	}
	function o(e, t, n, r, o) {
		...
		if (a)
			for (var i = 0; i < a.length; i++) {
				var s = a[i],
					u = s.data;
				if (u.handler === t && u.useCapturing === r && u.eventName === n) return o && a.splice(i, 1), s
		}
		return null
	}
	function a(e, t) {
	...
	function i(e, t, n, r) {
		...
		return function(t, n) {
			...
			if (!h || d) return p[u](a, c, f);
			if (!r) {
				var g = o(p, c, a, f, !1);
				if (g) return p[u](a, g.invoke, f)
			}
			var y = Zone.current,
	...
	function c(t) {
		...
		if (n) {
			...
			for (r in n) "prototype" !== r && n.hasOwnProperty(r) && (S[t][r] = n[r])
		}
	}
	function l(e, t) {
		try {
	...
	function p(e, t, n, r) {
		...
		function a(e) {
			return delete u[e.data.handleId]
				, s(e.data.handleId)
		}
		var i = null,
			s = null;
		...
		for (var e = function(e) {
					...
					self.addEventListener(t, function(e) {
						var t,
							r,
							o = e.target;
						for (r = o ? o.constructor.name + "." + n : "unknown." + n; o;) o[n] && !o[n][A] && (t = Zone.current.wrap(o[n], r), t[A] = o[n], o[n] = t), o = o.parentElement
					}, !0)
	...
	var E = (function(e) {
			...
			function l(e, t, r) {
				if (e[S] === Z)
					if (r instanceof C && r[S] !== Z) f(r), l(e, r[S], r[O]);
					else if (i(r)) r.then(c(e, t), c(e, !1));else {
						e[S] = t;
						var o = e[O];
						e[O] = r;
						for (var a = 0; a < o.length;) p(e, o[a++], o[a++], o[a++], o[a++]);
						if (0 == o.length && t == z) {
							e[S] = I;try {
			...
			var d = function() {
				...
				v = function() {
					...
					return e.prototype.fork = function(e, t) {
							...
							try {
								if (this._scheduleTaskZS) return this._scheduleTaskZS.onScheduleTask(this._scheduleTaskDlgt, this.zone, e, t);
								if (t.scheduleFn) t.scheduleFn(t);else {
									if ("microTask" != t.type)
							...
							if (this._cancelTaskZS)
								n = this._cancelTaskZS.onCancelTask(this._cancelTaskDlgt, this.zone, e, t);else {
								if (!t.cancelFn)
				...
				g = function() {
					function e(e, t, n, r, o, i, s) {
						this.runCount = 0, this.type = e, this.zone = t, this.source = n, this.data = o, this.scheduleFn = i, this.cancelFn = s, this.callback = r;var u = this;
